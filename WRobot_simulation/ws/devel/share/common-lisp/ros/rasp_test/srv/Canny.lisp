...
(cl:defmethod cl:initialize-instance :after ((m <Canny-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Canny-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rasp_test-srv:<Canny-request> is deprecated: use rasp_test-srv:Canny-request instead.")))

(cl:ensure-generic-function 'origin-val :lambda-list '(m))
(cl:defmethod origin-val ((m <Canny-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rasp_test-srv:origin-val is deprecated.  Use rasp_test-srv:origin instead.")
  (origin m))
...
(cl:defmethod cl:initialize-instance :after ((m <Canny-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Canny-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rasp_test-srv:<Canny-response> is deprecated: use rasp_test-srv:Canny-response instead.")))

(cl:ensure-generic-function 'canny-val :lambda-list '(m))
(cl:defmethod canny-val ((m <Canny-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rasp_test-srv:canny-val is deprecated.  Use rasp_test-srv:canny instead.")
  (canny m))
